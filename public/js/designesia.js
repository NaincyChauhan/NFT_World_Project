...
(function defaultFunc($) {
    console.log("main jquery function is running");
    'use strict';
    ...
    $(document).ready(function () {
        console.log("Document Second Function is running");
        ...
        // $(".nft__item_click").on("click", function() {
            $(".wrapper").on("click", ".nft__item_click", function() {
            // Find the nft__item_extra element within the clicked parent
            var nftItemExtra = $(this).closest(".nft__item").find(".nft__item_extra");
        ...
        $(".nft__item_click12121").click(function (){
            console.log("function running Very well hsere93434934398");
        })
